...
module physics
    ...
    contains
        ...
        subroutine initial()
            ...
            stars(4)%mass = m4
            stars(4)%x    = d4 !TODO
            stars(4)%xt   = stars(4)%x !TODO
            stars(4)%y    = 0.0 !TODO
            stars(4)%yt   = 0.0 !TODO
            stars(4)%vx   = 0.0 !TODO
            stars(4)%vxt  = 0.0 !TODO
            stars(4)%vy   = v4 !TODO
            stars(4)%vyt  = stars(4)%vy !TODO
            ...
            stars(5)%xt   = stars(5)%x !TODO
            stars(5)%y    = 0.0 !TODO
            stars(5)%yt   = 0.0 !TODO
            stars(5)%vx   = 0.0 !TODO
            stars(5)%vxt  = 0.0 !TODO
            stars(5)%vy   = v4+v5 !TODO
            stars(5)%vyt  = stars(5)%vy !TODO
            ...
            stars(6)%mass = m6
            stars(6)%x    = d6 !TODO
            stars(6)%xt   = stars(6)%x !TODO
            stars(6)%y    = 0.0 !TODO
            stars(6)%yt   = 0.0 !TODO
            stars(6)%vx   = 0.0 !TODO
            stars(6)%vxt  = 0.0 !TODO
            stars(6)%vy   = v6 !TODO
            stars(6)%vyt  = stars(6)%vy !TODO
            ...
            stars(7)%mass = m7
            stars(7)%x    = d7 !TODO
            stars(7)%xt   = stars(7)%x !TODO
            stars(7)%y    = 0.0 !TODO
            stars(7)%yt   = 0.0 !TODO
            stars(7)%vx   = 0.0 !TODO
            stars(7)%vxt  = 0.0 !TODO
            stars(7)%vy   = v7 !TODO
            stars(7)%vyt  = stars(7)%vy !TODO
            ...
            stars(8)%mass = m8
            stars(8)%x    = d8 !TODO
            stars(8)%xt   = stars(8)%x !TODO
            stars(8)%y    = 0.0 !TODO
            stars(8)%yt   = 0.0 !TODO
            stars(8)%vx   = 0.0 !TODO
            stars(8)%vxt  = 0.0 !TODO
            stars(8)%vy   = v8 !TODO
            stars(8)%vyt  = stars(8)%vy !TODO
            ...
            stars(9)%mass = m9
            stars(9)%x    = d9 !TODO
            stars(9)%xt   = stars(9)%x !TODO
            stars(9)%y    = 0.0 !TODO
            stars(9)%yt   = 0.0 !TODO
            stars(9)%vx   = 0.0 !TODO
            stars(9)%vxt  = 0.0 !TODO
            stars(9)%vy   = v9 !TODO
            stars(9)%vyt  = stars(9)%vy !TODO
            ...
            do j=1, N
                ...
                do k=1 ,N
                    if (j<k) then
                        ...
                        xt = stars(j)%xt - stars(k)%xt
                        yt = stars(j)%yt - stars(k)%yt
                    else if (j>k) then
                        x = -(stars(j)%x - stars(k)%x)
                        y = -(stars(j)%y - stars(k)%y)
                        xt = -(stars(j)%xt - stars(k)%xt)
                    ...
                    rsqt = xt*xt + yt*yt
                    anglet = atan(yt,xt)
                    forcet = G *stars(j)%mass *stars(k)%mass /rsqt

                    if (j<k) then
                        fx=fx-force*cos(angle)
                        fy=fy-force*sin(angle)

                        fxt=fxt-forcet*cos(anglet)
                        fyt=fyt-forcet*sin(anglet)
                    else if (j>k) then
                        fx=fx+force*cos(angle)
                        fy=fy+force*sin(angle)
