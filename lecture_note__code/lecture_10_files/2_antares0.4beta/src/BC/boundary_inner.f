      subroutine bnd_inner_outflow(den ,px ,py ,pz ,ene ,bx ,by ,bz ,
     &                             den2,px2,py2,pz2,ene2,bx2,by2,bz2,nd)
      ...
      den2(m1,m2,m3)= den(m4,m5,m6)
       px2(n1,n2,n3)= px(n4,n5,n6)
       px2(m1,m2,m3)= px(m4,m5,m6)
       py2(n1,n2,n3)= py(n4,n5,n6)
       py2(m1,m2,m3)= py(m4,m5,m6)
       pz2(n1,n2,n3)= pz(n4,n5,n6)
       pz2(m1,m2,m3)= pz(m4,m5,m6)
      if (.not. ISOTHERMAL)then
      ene2(n1,n2,n3)= ene(n4,n5,n6)
      ene2(m1,m2,m3)= ene(m4,m5,m6)
      endif
      if (MHD) then
       bx2(n1,n2,n3)= bx(n4,n5,n6)
       bx2(m1,m2,m3)= bx(m4,m5,m6)
       by2(n1,n2,n3)= by(n4,n5,n6)
       by2(m1,m2,m3)= by(m4,m5,m6)
       bz2(n1,n2,n3)= bz(n4,n5,n6)
       bz2(m1,m2,m3)= bz(m4,m5,m6)
      endif

      enddo
      enddo
      end
      subroutine bnd_inner_reflect(den ,px ,py ,pz ,ene ,bx ,by ,bz ,
     &                             den2,px2,py2,pz2,ene2,bx2,by2,bz2,nd)
      implicit none
      include 'fluid.h'
      include 'parameters'
      ...
      subroutine bnd_inner_periodic(den ,px ,py ,pz ,ene ,bx ,by ,bz ,
     &                             den2,px2,py2,pz2,ene2,bx2,by2,bz2,nd)
      implicit none
      include 'fluid.h'
      include 'parameters'
      ...
      subroutine bnd_inner_ini(den ,px ,py ,pz ,ene ,bx ,by ,bz ,
